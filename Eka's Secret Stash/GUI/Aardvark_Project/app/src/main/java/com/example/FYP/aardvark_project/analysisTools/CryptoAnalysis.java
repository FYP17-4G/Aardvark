...
package com.example.FYP.aardvark_project.analysisTools;

import com.example.FYP.aardvark_project.App_Framework;
import com.example.FYP.aardvark_project.GUI_project_view;
...
public class CryptoAnalysis extends GUI_project_view
{
    ...
    private App_Framework framework = new App_Framework(this, false);
