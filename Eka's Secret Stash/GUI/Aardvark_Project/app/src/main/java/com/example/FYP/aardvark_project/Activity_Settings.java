...
public class Activity_Settings extends AppCompatPreferenceActivity {
     ...
     * Access the value of the settings by calling shared preferences, by using one of the key below
     * */
    public static final String DARK_THEME_SWITCH = "dark_theme_preference";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //this variable is here to change the theme of the activity accordingly
