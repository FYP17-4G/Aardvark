...
public class RectangularKeyTranspositionTest {
  ...
  @Before
  public void init() {
    cipher = new RectangularKeyTransposition();
  }
  @Test
  ...
  public void encrypt_ShortAlpha() {
    ...
    Assert.assertEquals("muz", answer);
  }

  @Test
  public void encrypt_LongAlpha() {
    String answer = cipher.encrypt(LONG_ALPHA_ALT, TR_KEY);
    Assert.assertEquals("yqlgtxpkfrwojdcvnibezumhas", answer);
  }

  @Test
  public void decrypt_ShortAlpha() {
    String answer = cipher.decrypt("muz", TR_KEY);
    Assert.assertEquals(SHORT_ALPHA_ALT, answer);
  }

  @Test
  public void decrypt_LongAlpha() {
    String answer = cipher.decrypt("yqlgtxpkfrwojdcvnibezumhas", TR_KEY);
