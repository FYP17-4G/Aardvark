...
public class Playfair implements Cipher {
    ...
    public String encrypt(String plaintext, String key) throws InvalidKeyException {
        ...
        if ( (plaintext.length() % 2) != 0)
            plaintext = plaintext + Utility.getRandAlphabet();
    ...
    public String decrypt(String ciphertext, String key) throws InvalidKeyException {
        ...
        if ( (ciphertext.length() % 2) != 0)
            ciphertext = ciphertext + Utility.getRandAlphabet();
...
//            System.out.println();
    ...
    private void buildPlayfairSquare (String key) {
        String playfairKey = Utility.removeDuplicates(key + PLAYFAIR_ALPHABET);
        ...
        for (Character c: in.toCharArray()) {
            ...
            do {
                ...
                if (!temp.toString().equals(c.toString())) {
                    ...
                    temp.append(Utility.getRandAlphabet());
                    duplicate = true;
                }
    ...
    public Boolean checkKey(String key) throws InvalidKeyException {
        if (key.length() < 2) throw new InvalidKeyException("Key too short!");
